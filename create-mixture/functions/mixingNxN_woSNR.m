function H = mixingNxN_woSNR(mixoutRoot, signalFileName, RT60, distSensors, distSources, azimuthAngle, elevationAngle, targetFs, upFs, roomDim, centerSensor,rir_path)
