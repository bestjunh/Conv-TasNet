function [H, locationSensor, locationSource]=genNxN(fs, roomDim, RT60, k, centerSensor, distSensors, distSources, azimuthAngle, elevationAngle, n, rir_path)
