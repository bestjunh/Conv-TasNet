function H = mixingNxN(mixoutRoot, signalFileName, SNR, RT60, distSensors, distSources, azimuthAngle, elevationAngle, targetFs, upFs, roomDim, centerSensor,rir_path)
